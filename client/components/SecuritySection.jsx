        ...
        <div className="lg:w-2/3">
          ...
          <div className="flex flex-col gap-4 lg:gap-6 lg:grid lg:grid-cols-3">
            ...
            <div className="contents lg:flex lg:flex-col lg:gap-6">
              ...
              <div className="bg-white p-6 sm:p-8 shadow-sm flex items-center justify-between lg:h-[158px] relative">
                ...
                <div className="absolute right-6 sm:static">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="sm:w-6 sm:h-6 flex-shrink-0">
                    <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="#1d1d1f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
