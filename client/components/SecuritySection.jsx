    ...
    <section className="bg-[#f5f5f7] py-12 sm:py-16 lg:py-20">
      <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-16">
        <div className="lg:w-2/3">
          {/* Header */}
          <div className="mb-12">
            <h2 className="text-4xl sm:text-5xl font-semibold text-[#1d1d1f] mb-4" style={{ letterSpacing: '-0.5px' }}>
              Security is our top priority
            </h2>
            <p className="text-lg text-[#6e6e73] max-w-lg font-normal leading-relaxed">
          ...
          <div className="flex flex-col gap-6 lg:grid lg:grid-cols-3">
            {/* Security Card */}
            <div className="bg-white p-8 lg:p-10 shadow-sm relative flex flex-col lg:h-[340px]">
              ...
              <p className="text-[15px] text-[#6e6e73] leading-relaxed flex-grow">
                Protecting your data at every layer is fundamental to how Intervue works
              </p>
              
              <div className="lg:absolute lg:bottom-10 lg:left-8">
            ...
            <div className="contents lg:flex lg:flex-col lg:gap-6">
              ...
              <div className="bg-white p-8 shadow-sm flex items-center justify-between lg:h-[158px]">
